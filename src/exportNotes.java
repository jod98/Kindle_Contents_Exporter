...
public class exportNotes {
    ...
    /* Global File Paths */
    private static final String kindleInputFile = "G:/documents/My Clippings.txt";
    private static final String kindleHighlightsFile = "Kindle_Highlights.docx";

    /* Global Data Structures */
    private static final ArrayList<String> titles = new ArrayList<>();
    private static final ArrayList<String> highlights = new ArrayList<>();
    ...
    private static void kindleNotesExporter() {
        readKindleFile();
        exportToHashMap();
        exportToDocx();
    }
